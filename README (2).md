...
> **English:** A powerful **Discord AI bot** that understands natural language (Arabic & English) and executes server actions automatically — **126 skills**, admin-only security, blazing-fast LLM routing, and zero config hassle. Built with **Python + discord.py + Groq LLM**.
...
[![Stars](https://img.shields.io/github/stars/j4oc/Disor?style=for-the-badge&logo=github&color=gold)](https://github.com/j4oc/Disor/stargazers)
[![Forks](https://img.shields.io/github/forks/j4oc/Disor?style=for-the-badge&logo=github&color=blue)](https://github.com/j4oc/Disor/forks)
...
<a href="https://github.com/j4oc">
<img src="https://img.shields.io/badge/🐙_قيت_هاوب_j4oc-181717?style=for-the-badge&logo=github&logoColor=white"/>
</a>
</td>
</tr>
</table>
...
|---|---|---|
| 11 مجموعات كاملة من إدارة السيرفر | CI + اختبارات + متغيرات بيئة + keep-alive | بيتكلم معاك زي صاحبك — مش روبوت جاف |
...
```bash
git clone https://github.com/j4oc/Disor.git
cd Disor
...
عايز تساهم أو تطور من المشروع؟ إزاي تعمل **Fork** وتشتغل:

```bash
# 1) اعمل Fork من صفحة الريبو (زر Fork فوق يمين)
# 2) انسخ نسختك على جهازك:
git clone https://github.com/j4oc/Disor.git
cd Disor

# 3) اعمل فرع جديد لميزتك:
git checkout -b feature/اسم-الميزة

# 4) عدّل واختبر:
python -m pytest tests/ -v

# 5) ارفع الفرع واعمل Pull Request:
git add .
git commit -m "✨ ميزة جديدة"
git push origin feature/اسم-الميزة
```

> ⚠️ **مهم**: `data.json` (فيه التوكن) في `.gitignore` — مستحيل يتسرب للريبو.
> وشوف [CONTRIBUTING.md](CONTRIBUTING.md) قبل ما تعمل Pull Request.
...
<!-- أزرار المشاركة — تساعد على نشر المشروع -->
<a href="https://twitter.com/intent/tweet?text=🤖%20Disor%20NX%20Edition%20—%20Discord%20AI%20Bot%20with%20126%20skills!%20https://github.com/j4oc/Disor">
<img src="https://img.shields.io/badge/🐦_شارك_على_تويتر-1DA1F2?style=for-the-badge&logo=twitter&logoColor=white"/>
</a>
<a href="https://wa.me/?text=🤖%20شوف%20هذا%20البوت%20—%20Discord%20AI%20Bot%20126%20مهارة%20https://github.com/j4oc/Disor">
<img src="https://img.shields.io/badge/💬_شارك_على_واتساب-25D366?style=for-the-badge&logo=whatsapp&logoColor=white"/>
</a>
<a href="https://www.reddit.com/submit?url=https://github.com/j4oc/Disor&title=Disor%20-%20Discord%20AI%20Bot%20with%20126%20skills">
<img src="https://img.shields.io/badge/📣_شارك_على_ريديت-FF4500?style=for-the-badge&logo=reddit&logoColor=white"/>
</a>

<br/>

**💡 ساعدنا: لو المشروع عجبك، اضغط ⭐ Star في أعلى الصفحة — كل نجمة بتدعم المشروع!**
